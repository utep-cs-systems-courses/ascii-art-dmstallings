...
- Add a function to print an arrow. This will require you to
  (1) define function print_arrow() in print_shapes.c,
  (2) Adding a declaration for print_arrow() to draw.h, and
  (3) add a command "t" to uimain.c.
